...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__47925__auto__,writer__47926__auto__,opt__47927__auto__){
return cljs.core._write.call(null,writer__47926__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__49882 = o;
(G__49882[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__49884__i < G__49884__a.length) {G__49884__a[G__49884__i] = arguments[G__49884__i + 0]; ++G__49884__i;}
  args = new cljs.core.IndexedSeq(G__49884__a,0);
} 
...
if(cljs.core.truth_((function (){var and__47261__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__47261__auto__){
var and__47261__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__49891 = jsprops;
(G__49891["defaultValue"] = value);

(G__49891["onChange"] = ((function (G__49891,v,value,on_change){
return (function (p1__49888_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__49888_SHARP_);
});})(G__49891,v,value,on_change))
);

(G__49891["ref"] = ((function (G__49891,v,value,on_change){
return (function (p1__49889_SHARP_){
return (this$["cljsInputElement"] = p1__49889_SHARP_);
});})(G__49891,v,value,on_change))
);
...
var vec__49898 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__49898,(0),null);
var id = cljs.core.nth.call(null,vec__49898,(1),null);
var class$ = cljs.core.nth.call(null,vec__49898,(2),null);
...
var jsprops = ({"argv": v});
var temp__6507__auto___49903 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6507__auto___49903 == null)){
} else {
var key_49904 = temp__6507__auto___49903;
(jsprops["key"] = key_49904);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__49906 = (new reagent.impl.template.NativeWrapper());
(G__49906["name"] = c);
...
var len__48456__auto___49912 = arguments.length;
var i__48457__auto___49913 = (0);
while(true){
if((i__48457__auto___49913 < len__48456__auto___49912)){
args__48463__auto__.push((arguments[i__48457__auto___49913]));

var G__49914 = (i__48457__auto___49913 + (1));
i__48457__auto___49913 = G__49914;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__48464__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq49910){
var G__49911 = cljs.core.first.call(null,seq49910);
var seq49910__$1 = cljs.core.next.call(null,seq49910);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__49911,seq49910__$1);
});
...
break;
default:
var G__49918 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__49918;
continue;
...
var n__48286__auto___49921 = a.length;
var i_49922 = (0);
while(true){
if((i_49922 < n__48286__auto___49921)){
(a[i_49922] = reagent.impl.template.as_element.call(null,(a[i_49922])));

var G__49923 = (i_49922 + (1));
i_49922 = G__49923;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__48286__auto___49924 = a.length;
var i_49925 = (0);
while(true){
if((i_49925 < n__48286__auto___49924)){
var val_49926 = (a[i_49925]);
if((cljs.core.vector_QMARK_.call(null,val_49926)) && ((reagent.impl.template.key_from_vec.call(null,val_49926) == null))){
(o["no-key"] = true);
} else {
}

(a[i_49925] = reagent.impl.template.as_element.call(null,val_49926));

var G__49927 = (i_49925 + (1));
i_49925 = G__49927;
continue;
} else {
}
...
var ctx = ({});
var vec__49931 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__49931,(0),null);
var derefed = cljs.core.nth.call(null,vec__49931,(1),null);
...
var G__49935 = (cljs.core.count.call(null,argv) - first_child);
switch (G__49935) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__49935){
