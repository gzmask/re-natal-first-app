...
var len__48456__auto___49707 = arguments.length;
var i__48457__auto___49708 = (0);
while(true){
if((i__48457__auto___49708 < len__48456__auto___49707)){
args__48463__auto__.push((arguments[i__48457__auto___49708]));

var G__49709 = (i__48457__auto___49708 + (1));
i__48457__auto___49708 = G__49709;
continue;
} else {
}
break;
...
return re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic(argseq__48464__auto__);
});

re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__49704){
var map__49705 = p__49704;
var map__49705__$1 = ((((!((map__49705 == null)))?((((map__49705.cljs$lang$protocol_mask$partition0$ & (64))) || (map__49705.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49705):map__49705);
var m = map__49705__$1;
var name = cljs.core.get.call(null,map__49705__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var id = cljs.core.get.call(null,map__49705__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var before = cljs.core.get.call(null,map__49705__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.call(null,map__49705__$1,new cljs.core.Keyword(null,"after","after",594996914));
...
var temp__6501__auto___49710 = cljs.core.seq.call(null,clojure.set.difference.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,cljs.core.dissoc.call(null,m,new cljs.core.Keyword(null,"name","name",1843675177)))),re_frame.interceptor.mandatory_interceptor_keys));
if(temp__6501__auto___49710){
var unknown_keys_49711 = temp__6501__auto___49710;
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"error","error",-978969032),"re-frame: ->interceptor ",m," has unknown keys: ",unknown_keys_49711);
} else {
}
} else {
}

return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__47273__auto__ = id;
if(cljs.core.truth_(or__47273__auto__)){
return or__47273__auto__;
} else {
var or__47273__auto____$1 = name;
...
re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq49703){
return re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq49703));
});

re_frame.interceptor.get_effect = (function re_frame$interceptor$get_effect(var_args){
var args49712 = [];
var len__48456__auto___49715 = arguments.length;
var i__48457__auto___49716 = (0);
while(true){
if((i__48457__auto___49716 < len__48456__auto___49715)){
args49712.push((arguments[i__48457__auto___49716]));

var G__49717 = (i__48457__auto___49716 + (1));
i__48457__auto___49716 = G__49717;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args49712.length)].join('')));
...
var args49719 = [];
var len__48456__auto___49722 = arguments.length;
var i__48457__auto___49723 = (0);
while(true){
if((i__48457__auto___49723 < len__48456__auto___49722)){
args49719.push((arguments[i__48457__auto___49723]));

var G__49724 = (i__48457__auto___49723 + (1));
i__48457__auto___49723 = G__49724;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args49719.length)].join('')));
...
var temp__6501__auto__ = cljs.core.get.call(null,interceptor,direction);
...
var args49727 = [];
var len__48456__auto___49730 = arguments.length;
var i__48457__auto___49731 = (0);
while(true){
if((i__48457__auto___49731 < len__48456__auto___49730)){
args49727.push((arguments[i__48457__auto___49731]));

var G__49732 = (i__48457__auto___49731 + (1));
i__48457__auto___49731 = G__49732;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args49727.length)].join('')));
