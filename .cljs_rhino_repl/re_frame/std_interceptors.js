...
var vec__49545_49548 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_49549 = cljs.core.nth.call(null,vec__49545_49548,(0),null);
var only_after_49550 = cljs.core.nth.call(null,vec__49545_49548,(1),null);
var db_changed_QMARK__49551 = (cljs.core.some_QMARK_.call(null,only_before_49549)) || (cljs.core.some_QMARK_.call(null,only_after_49550));
if(db_changed_QMARK__49551){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_49549);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_49550);
...
var map__49558 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__49558__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__49558__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__49566 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__49566__$1;
var event = cljs.core.get.call(null,map__49566__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__48456__auto___49569 = arguments.length;
var i__48457__auto___49570 = (0);
while(true){
if((i__48457__auto___49570 < len__48456__auto___49569)){
args__48463__auto__.push((arguments[i__48457__auto___49570]));

var G__49571 = (i__48457__auto___49570 + (1));
i__48457__auto___49570 = G__49571;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__48464__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq49568){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq49568));
});
...
var args__48463__auto__ = [];
var len__48456__auto___49577 = arguments.length;
var i__48457__auto___49578 = (0);
while(true){
if((i__48457__auto___49578 < len__48456__auto___49577)){
args__48463__auto__.push((arguments[i__48457__auto___49578]));

var G__49579 = (i__48457__auto___49578 + (1));
i__48457__auto___49578 = G__49579;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__48464__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__49572_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__49573_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__49573_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq49574){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__49575,G__49576,seq49574__$2);
});
